...
#include "include/jz4770-cpm.h"
#include "include/jz4770-ddrc.h"
#include "include/jz4770-gpio.h"
...
unsigned int get_memory_size(void) {
	return (1 << (DDR_ROW + DDR_COL + DDR_DW32 + DDR_BANK8 + 3)) * (DDR_CS1EN + DDR_CS0EN);
}
